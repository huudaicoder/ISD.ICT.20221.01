...
public class BikeTest {
	...
	@ParameterizedTest
	@CsvSource({ "ABC, normal, laksjfhbg/alkjfhg, 135afg21, 10, 300, VND, 12/03/2021",
	...
	public void BikeConstructorTestOK(String name, String bike_type, String bike_image, String bar_code,
			double bike_rental_price, double deposit, String currency, String create_date) {
		boolean isValid = true;
		try {
			NormalBike bike = new NormalBike(name, bike_type, bike_image, bar_code, bike_rental_price, deposit,
	...
	@ParameterizedTest
	@CsvSource({ "1ABC, normal, laksjfhbg/alkjfhg, 135afg21, 10, 300, VND, 12/03/2021",
			"AB?C, normal, laksjfhbg/alkjfhg, 135afg21, 10, 300, VND, 12/03/2021",
	...
	public void BikeConstructorTestException(String name, String bike_type, String bike_image, String bar_code,
			double bike_rental_price, double deposit, String currency, String create_date) {
		try {
			NormalBike bike = new NormalBike(name, bike_type, bike_image, bar_code, bike_rental_price, deposit,
					currency, create_date);
	...
	@ParameterizedTest
	@CsvSource({ ", normal, laksjfhbg/alkjfhg, 135afg21, 10, 300, VND, 12/03/2021",
			"ABC, , laksjfhbg/alkjfhg, 135afg21, 10, 300, VND, 12/03/2021",
			"ABC, normal, , 135afg21, 10, 300, VND, 12/03/2021",
			"ABC, normal, laksjfhbg/alkjfhg, , 0, 300, VND, 12/03/2021", })
	public void BikeConstructorTestNullException(String name, String bike_type, String bike_image, String bar_code,
			double bike_rental_price, double deposit, String currency, String create_date) {
		try {
			NormalBike bike = new NormalBike(name, bike_type, bike_image, bar_code, bike_rental_price, deposit,
					currency, create_date);
